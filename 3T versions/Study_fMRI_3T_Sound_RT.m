...
config_log( ['logs\fMRI_' subjName '_Sound_RT.log'] );
...
% Visual Task
frame = strcat(stimFolder,'framehandRT.jpeg');
welcome = strcat(stimFolder,'welcomesoundRT.jpg');
fixcross = strcat(stimFolder,'fixcrosshandRT.jpeg');
thanks = strcat(stimFolder,'thankshandRT.jpeg');
breakimg = strcat(stimFolder,'breakhandRT.jpeg');
extension = '.wav';  
...
for a = 1:32
   ...
   % Takes the trial number and derives jitter
    ...
    info{trial,2} = 'RT';                                      % If taskCategory is audio, records roundLeft (1 = rounded left, 2 = stretched left)
...
%% The grand finale
    ...
    %%
    save(strcat(subjFolder,'/info','_',listList,'Sounds_RT','.mat'),('info'));         % This saves the created cell array named 'info' into each participants individually created folder.
    xlswrite(strcat(subjFolder,'_',listList,'Sound_RT'),info);   
    %%
